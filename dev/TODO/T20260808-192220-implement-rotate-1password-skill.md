...
- [T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441)'s brainstorm pass (2026-08-08) finalized the design for a
...
- No code exists yet. Full design (flow, security invariant, rollback
  ...
  `synxdb-team`) — read it in full before starting; this file only
  summarizes.

## Design summary (see [T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441) for the full write-up)

- **v1 scope**: single repo — `synxdb-build-pipeline`'s
...
- **Rollback**: human-only, via 1Password's own item-version-history UI (not
  ...
  should print the step-by-step recovery procedure from [T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441)'s
...
- Design first: this task should still get its own brainstorm/design-review
  ...
  org's "design first, implement second" convention — [T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441)
...
- Cross-repo secret discovery ([T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441) v2 follow-on, not yet filed).
- The `rotate-secrets.yml` extension to write Auto-tier values into
  1Password — separate task, [T20260808-413336](https://github.com/Synx-Data-Labs/synxdb-team/issues/455).

## Dependencies

- ~~**[T20260806-374741](https://github.com/Synx-Data-Labs/synxdb-team/issues/441)** — the finalized design this implements.~~ ✅ Done (see synxdb-team's dev/JOURNAL/2026-08-08-T20260806-374741-rotate-1password-skill-design.md)
- **[T20260806-240910](https://github.com/Synx-Data-Labs/synxdb-team/issues/440)** — 1Password → doc links; useful but not a hard
...
- Migrated from `synxdb-team/dev/TODO/` by T20260827-420045 — the task's
  `target-repo: Synx-Data-Labs/synx-skills` field (set 2026-08-08, before
  ...
  already lives in — landing here directly instead of `synx-skills`.
