...
- **Not in scope**: `/todo sweep`'s mutating logic (Phase 2 blocker-order enforcement, Phase 3 auto-close + Park judgment calls) — those stay in the skill, they make real decisions, not just a deterministic read.
