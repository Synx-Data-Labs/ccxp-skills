...
# T20260615-777777 — Refresh the onboarding glossary
...
- [ ] No broken cross-links — `markdownlint` run output clean.

## Root cause

_(pending — code-only section, should not be here for a docs task)_
